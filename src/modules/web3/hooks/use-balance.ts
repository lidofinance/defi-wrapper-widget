...
import { PROVIDER_POLLING_INTERVAL } from '@/config';
...
export const useEthereumBalance = () => {
  ...
  const queryData = useBalance({
    ...
    query: {
      ...
      staleTime: PROVIDER_POLLING_INTERVAL,
      refetchInterval: PROVIDER_POLLING_INTERVAL,
...
const useTokenBalance = (
  ...
  const balanceQuery = useReadContract({
    ...
    query: {
      ...
      staleTime: PROVIDER_POLLING_INTERVAL * 2,
      refetchInterval: PROVIDER_POLLING_INTERVAL * 2,
    },
  });
